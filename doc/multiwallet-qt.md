...
In order to support loading of multiple wallets in anykeycoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is anykeycoin.cpp.
...
Changes to anykeycoin.cpp
----------------------
anykeycoin.cpp is the entry point into anykeycoin-qt, and as such, will require some minor modifications to provide hooks for
