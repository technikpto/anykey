...
This mechanism has been integrated into Bitcore-Node-AnyKeyCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/AnyKeyCoin-Project/insight-api-anykeycoin#web-socket-api](https://github.com/AnyKeyCoin-Project/insight-api-anykeycoin#web-socket-api) 
* API: [https://github.com/AnyKeyCoin-Project/insight-api-anykeycoin#swifttx-transactions](https://github.com/AnyKeyCoin-Project/insight-api-anykeycoin#swifttx-transactions) 
...
By default, the AnyKeyCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the AnyKeyCoin Core daemon:
