...
/** Utility functions used by the AnyKey Coin Qt UI.
 */
namespace GUIUtil
{
...
// Render AnyKey Coin addresses in monospace font
...
// Parse "anykeycoin:" URI into recipient object, return true on successful parsing
