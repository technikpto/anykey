                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("AnyKey Coin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a AnyKey Coin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and anykeycoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About AnyKey Coin Core"), this);
    aboutAction->setStatusTip(tr("Show information about AnyKey Coin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for AnyKey Coin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your AnyKey Coin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified AnyKey Coin addresses"));
    ...
    openAction->setStatusTip(tr("Open a AnyKey Coin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the AnyKey Coin Core help message to get a list with possible AnyKey Coin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("AnyKey Coin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to AnyKey Coin network", "", count));
}
...
{
    QString strTitle = tr("AnyKey Coin Core"); // default title
