...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("AnyKey Coin Core"),
     ...
     * override -datadir in the anykeycoin.conf file in the default data directory
     * (to be consistent with anykeycoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
