...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("anykeycoin Core anykeycoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  anykeycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded anykeycoin transaction") + "\n" +
                               "  anykeycoin-tx [options] -create [commands]   " + _("Create hex-encoded anykeycoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded anykeycoin transaction
