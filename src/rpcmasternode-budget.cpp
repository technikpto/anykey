...
Value mnbudget(const Array& params, bool fHelp)
{
    ...
    if (fHelp ||
        ...
        throw runtime_error(
            ...
            "  vote-many          - Vote on a AnyKey Coin initiative\n"
            "  vote-alias         - Vote on a AnyKey Coin initiative\n"
            "  vote               - Vote on a AnyKey Coin initiative/budget\n"
...
Value preparebudget(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 6)
        throw runtime_error(
            "preparebudget \"proposal-name\" \"url\" payment-count block-start \"anykeycoin-address\" monthy-payment\n"
            ...
            "5. \"anykeycoin-address\":   (string, required) AnyKey Coin address to send payments to\n"
...
Value submitbudget(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 7)
        throw runtime_error(
            "submitbudget \"proposal-name\" \"url\" payment-count block-start \"anykeycoin-address\" monthy-payment \"fee-tx\"\n"
...
Value getbudgetprojection(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "    \"PaymentAddress\": \"xxxx\",     (string) AnyKey Coin address of payment\n"
