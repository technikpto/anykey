...
#if defined(NDEBUG)
#error "AnyKey Coin cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
	...
	else if (nHeight <= 60000 && nHeight >= 15001) {
        nSubsidy = 15 * COIN;
    }
	else if (nHeight <= 185000 && nHeight >= 60001) {
        nSubsidy = 45 * COIN;
    }
	else if (nHeight <= 315000 && nHeight >= 185001) {
        nSubsidy = 135 * COIN;
    }
	else if (nHeight <= 445000 && nHeight >= 315001) {
        nSubsidy = 405 * COIN;
    }
	else if (nHeight <= 575000 && nHeight >= 445001) {
        nSubsidy = 1215 * COIN;
    }
	else if (nHeight <= 705000 && nHeight >= 575001) {
        nSubsidy = 3645 * COIN;
    }
	else if (nHeight <= 1000000 && nHeight >= 705001) {
        nSubsidy = 10935 * COIN;
    }
    else {
        nSubsidy = 10935 * COIN;
...
{
    RenameThread("anykeycoin-scriptch");
