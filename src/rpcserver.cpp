...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop AnyKey Coin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "AnyKey Coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* AnyKey Coin features */
        {"anykeycoin", "masternode", &masternode, true, true, false},
        {"anykeycoin", "listmasternodes", &listmasternodes, true, true, false},
        {"anykeycoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"anykeycoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"anykeycoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"anykeycoin", "masternodedebug", &masternodedebug, true, true, false},
        {"anykeycoin", "startmasternode", &startmasternode, true, true, false},
        {"anykeycoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"anykeycoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"anykeycoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"anykeycoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"anykeycoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"anykeycoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"anykeycoin", "mnbudget", &mnbudget, true, true, false},
        {"anykeycoin", "preparebudget", &preparebudget, true, true, false},
        {"anykeycoin", "submitbudget", &submitbudget, true, true, false},
        {"anykeycoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"anykeycoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"anykeycoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"anykeycoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"anykeycoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"anykeycoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"anykeycoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"anykeycoin", "checkbudgets", &checkbudgets, true, true, false},
        {"anykeycoin", "mnsync", &mnsync, true, true, false},
        {"anykeycoin", "spork", &spork, true, true, false},
        {"anykeycoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"anykeycoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use anykeycoind, or the -server option to anykeycoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> anykeycoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:27271/\n";
}
